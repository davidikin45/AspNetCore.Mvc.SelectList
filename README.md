...
Gives the ability to specify select lists via Model Attributes
...
| SelectListFileAttribute    | Specify physical or virtual path such as "~/files/" |
| SelectListFolderAttribute  | Specify physical or virtual path such as "~/files/" |
