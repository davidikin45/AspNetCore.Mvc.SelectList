...
{
    [HtmlTargetElement("checkbox-button-list", Attributes = ForAttributeName )]
    [HtmlTargetElement("checkbox-button-list", Attributes = ItemsAttributeName)]
    [HtmlTargetElement("checkbox-button-list", Attributes = "name")]
    public class CheckboxButtonListTagHelper : TagHelper
    {
        ...
        public CheckboxButtonListTagHelper(IHtmlGenerator generator)
        {
            Generator = generator;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            var tagBuilder2 = SelectListHtmlGenerator.GenerateCheckboxValueButtonList(
               ViewContext,
               For.ModelExplorer,
               expression: For.Name,
               selectList: items,
